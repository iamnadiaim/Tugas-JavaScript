...
class Penyewaan {
    ...
    dataPenyewaan(nama, nomorTelepon, sewaKendaraan) {
...
sistemManajemenTransportasi.dataPenyewaan("Nadia Intan Muziza", "089678456234", mobil);
sistemManajemenTransportasi.dataPenyewaan("Melati Mawar", "081234567890", motor);
